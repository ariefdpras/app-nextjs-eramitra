            ...
            <div className="container-inner">
                ...
                <div className="products-container">
                    <div className="left-products">
                        ...
                        {
                            isBrands && <div className="group-list-wrapper"> {props.brands && props.brands.map((brand, idx) => <a href={`${process.env.ROOT_DOMAIN}/products/brand/${brand.id}`}><p className="group-list">{brand.name}</p></a>)}</div>
                          }
                        <div className="category-group">
                          <h3 className="category-side-title ">
                              Industry
                          ...
                          {
                            isIndustry && <div className="group-list-wrapper"> {props.industries && props.industries.map((industry, idx) => <a href={`${process.env.ROOT_DOMAIN}/products/industry/${industry.id}`}><p className="group-list">{industry.name}</p></a>)}</div>
                          }
                        <div className="category-group">
                          <h3 className="category-side-title ">
                              Application
                          ...
                          {
                            isApplication && <div className="group-list-wrapper"> {props.applications && props.applications.map((application, idx) => <a href={`${process.env.ROOT_DOMAIN}/products/application/${application.id}`}><p className="group-list">{application.name}</p></a>)}</div>
                          }
                    </div>
...
export async function getServerSideProps(req) {
  ...
  const getProducts = await fetch(`${process.env.ROOT_DOMAIN}/api/getProduct?industry=${req.query.slug}`)
