...
var ButtonBase = /*#__PURE__*/external_react_.forwardRef(function ButtonBase(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(ComponentProp, _extends({
  ...
  external_react_.createElement(ButtonBase_TouchRipple, _extends({
    ref: rippleRef,
    center: centerRipple
...
/* harmony default export */ const FirstPage = (createSvgIcon( /*#__PURE__*/external_react_.createElement("path", {
...
/* harmony default export */ const LastPage = (createSvgIcon( /*#__PURE__*/external_react_.createElement("path", {
...
/* harmony default export */ const NavigateBefore = (createSvgIcon( /*#__PURE__*/external_react_.createElement("path", {
...
/* harmony default export */ const NavigateNext = (createSvgIcon( /*#__PURE__*/external_react_.createElement("path", {
...
var PaginationItem = /*#__PURE__*/external_react_.forwardRef(function PaginationItem(props, ref) {
  ...
  return type === 'start-ellipsis' || type === 'end-ellipsis' ? /*#__PURE__*/external_react_.createElement("div", {
    ref: ref,
    className: external_clsx_default()(classes.root, classes.ellipsis, disabled && classes.disabled, size !== 'medium' && classes["size".concat(capitalize(size))])
  }, "\u2026") : /*#__PURE__*/external_react_.createElement(ButtonBase_ButtonBase, _extends({
    ref: ref,
    component: component,
    disabled: disabled,
    focusVisibleClassName: classes.focusVisible,
    className: external_clsx_default()(classes.root, classes.page, classes[variant], classes[shape], className, color !== 'standard' && classes["".concat(variant).concat(capitalize(color))], disabled && classes.disabled, selected && classes.selected, size !== 'medium' && classes["size".concat(capitalize(size))])
  }, other), type === 'page' && page, Icon ? /*#__PURE__*/external_react_.createElement(Icon, {
    className: classes.icon
  }) : null);
});
 false ? 0 : void 0;
/* harmony default export */ const PaginationItem_PaginationItem = (styles_withStyles(PaginationItem_styles, {
...
var Pagination = /*#__PURE__*/external_react_.forwardRef(function Pagination(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement("nav", _extends({
 ...
 false ? 0 : void 0;
/* harmony default export */ const Pagination_Pagination = (styles_withStyles(Pagination_styles, {
  name: 'MuiPagination'
})(Pagination));
