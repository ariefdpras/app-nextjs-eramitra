...
async function getServerSideProps(req) {
  ...
  const getProducts = await fetch(`${"https://eramitra.com"}/api/getProduct?industry=${req.query.slug}`);
  const products = await getProducts.json();
  const getIndustry = await fetch(`${"https://eramitra.com"}/api/getIndustry/${req.query.slug}`);
