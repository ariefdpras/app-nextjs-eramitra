...
async function getServerSideProps(req) {
  ...
  const getIndustries = await fetch(`${"http://staging.eramitra.com"}/api/getIndustry`);
  ...
  const getProducts = await fetch(`${"http://staging.eramitra.com"}/api/getProduct?industry=${req.query.slug}`);
  const products = await getProducts.json();
  const getIndustry = await fetch(`${"http://staging.eramitra.com"}/api/getIndustry/${req.query.slug}`);
