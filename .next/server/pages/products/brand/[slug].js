...
async function getServerSideProps(req) {
  ...
  const getProducts = await fetch(`${"http://staging.eramitra.com"}/api/getProduct?brand=${req.query.slug}`);
  const products = await getProducts.json();
  const getBrand = await fetch(`${"http://staging.eramitra.com"}/api/getBrands/${req.query.slug}`);
...
var __webpack_exports__ = __webpack_require__.X(0, [664,862,641,652], () => (__webpack_exec__(6703)));
